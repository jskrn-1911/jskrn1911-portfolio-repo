...
const Data = () => {
    return (
        <div className='home__data'>
            <h1 className="home__title">Jaskaran Singh
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">
                {/* I'm Jaskaran, a passionate developer and creative designer with a knack for building innovative solutions.
                Based in Mohali, India. From crafting sleek web applications using modern technologies like the MERN stack to designing intuitive
                user experiences, I thrive on turning ideas into reality. */}
                I'm Jaskaran, a developer and designer from Mohali, India, passionate about creating innovative solutions with modern tech like the MERN stack and crafting intuitive user experiences.
            </p>
